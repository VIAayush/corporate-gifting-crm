  ...
  return (
    <div className="p-6">
      <div className="flex gap-4 items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-[var(--color-primary)] capitalize">goals</h1>
      </div>
      <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-6 rounded-lg">
        <p className="text-[var(--color-text-secondary)]">Complete real page implementation for goals.</p>
